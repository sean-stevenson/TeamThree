              ...
              while(Redsum < 150){
                ...
                if(num < 20){ //If not enough pixels are found, reverse and reset
                    ...
                    if(pSignal > 0){/**right*/
                        ...
                        set_motor(1, 40 + pSignal + dSignal);/**From a few calculations 40 seems roughly right, max value is 70ish*/
                        }else{
                            set_motor(1, 0);
                        }
                        set_motor(2, -40.5);/**Minuses values if signal is minus it is double negative therefore positive*/
                        Sleep(0, 5000);
                    }
                }
